...
from app.mapping import STUDENT_QUERY_PARAMS, USER_QUERY_PARAMS, ENROLLMENT_RECORD_PARAMS
...
def get_students(**params) -> Optional[Dict[str, Any]]:
    ...
    query_params = {k: v for k, v in params.items() if v is not None and k in valid_params}
...
async def verify_student_by_id(student_id: str, **params) -> bool:
    ...
    try:
        ...
        return bool(student_data and (isinstance(student_data, list) and len(student_data) > 0))
