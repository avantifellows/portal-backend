...
def get_group_by_child_id_and_type(child_id: str, group_type: str) -> Optional[Dict[str, Any]]:
...
def get_group(**params) -> Optional[Dict[str, Any]]:
    ...
    query_params = {k: v for k, v in params.items() if v is not None and k in GROUP_QUERY_PARAMS}
