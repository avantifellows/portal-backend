...
from app.mapping import USER_QUERY_PARAMS
...
def get_users(**params) -> Optional[Dict[str, Any]]:
    ...
    query_params = {k: v for k, v in params.items() if v is not None and k in USER_QUERY_PARAMS}
...
def get_user_by_email_and_phone(email: str = None, phone: str = None) -> Optional[Dict[str, Any]]:
